            ...
            <div class="col-sm-6 ">
                <div class="contactinfo">
                    <ul class="nav nav-pills">
                        <li><a href=""><i class="fa fa-phone"></i> 01696 880 115</a></li>
                        <li><a href=""><i class="fa fa-envelope"></i> dat26061994@gmail.com</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-sm-8">
                <div class="pull-right">
                    <ul class="nav navbar-nav collapse navbar-collapse">
                        <li class="dropdown">
                            @if (Auth::check())
                                <a href="#" class=""><i class="fa fa-user"></i> {{ Auth::user()->name }}<i

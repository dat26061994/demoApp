...
<div class="left-sidebar">
    <div class="row">
        <h2>Best Seller</h2>
            ...
            <div class="row">
              <div class="col-md-5">
              <a href="" class="thumbnail"><img  src="{{ url('resources/upload/'.$item_seller->image) }}" alt=""></a> 
              </div>
              <div class="col-md-7">
    ...
    <div class="row">
        <h2>Latest Products</h2>
            ...
            <div class="row">
              <div class="col-md-5">
              <a href="" class="thumbnail"><img  src="{{ url('resources/upload/'.$item_product_latest->image) }}" alt=""></a> 
              </div>
              <div class="col-md-7">
